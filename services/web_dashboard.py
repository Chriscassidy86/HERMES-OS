...
class WebDashboardService:
 def __init__(self,command_center,version="V5 development"): self.command_center=command_center; self.version=version
 def build(self,*,multi_timeframe=None,executive_brief=None,learning_explanation=None,experiment_status=None,research_run=None,recent_alerts=(),operator_workflow=None):
