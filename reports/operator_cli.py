...
def main():
    parser=argparse.ArgumentParser(); parser.add_argument("database"); parser.add_argument("report",choices=("status","cycle","evidence","portfolio","positions","trades","pnl","rejections","risk","provider","integrity")); args=parser.parse_args()
